...
import com.samples.vertx.reactive.visitor.model.HistoricalTickerRxResponse;
...
public interface IVisitor<T> {
	...
	default void visit(HistoricalTickerRxResponse model) {
		throw new UnsupportedOperationException
				("visit(HistoricalTickerRxResponse) is not supported."); 
	}
